...
- 📄 **Guide**: A ``PDF`` guide with instructions to complete the project (currently only available in Spanish).
- 💻 **Script**: Two ``.py`` files to get in touch with computer camera.
...
- 📖 **README**: With links to get other project examples.
...
## Get ready 🤓 (Some other projects! 🛠️)
In this section, you can find the links of some other amazing project repositories:
- Mini Game of Ping-Pong: [Ping-Pong](https://github.com/isabelMorell/VOI_ProyectoFinal)
- Filtros de realidad aumentada: [Realidad Aumentada](https://github.com/Mariacarrenonindecardona/TrabajoFinalVisionRaquelMaria)
- A basketball points counter: [PI-Basketball](https://github.com/miguel-ara/RaspberryPI_Basketball_CV)
- A human-computer pattern communication: [Wandavision](https://github.com/danidss/wandavision)
